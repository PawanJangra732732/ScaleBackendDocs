...
This endpoint allows users to retrieve all feedback entries with pagination and search functionality. The response includes paginated feedback entries and additional pagination details.
...
```
GET /feedbacks?page=1&pageSize=10&q=john
```
...
The `getAllFeedbacks` function handles the retrieval of all feedback entries with pagination and search functionality. It performs the necessary operations as described above.